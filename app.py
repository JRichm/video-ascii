...
class Window:
    def __init__(self):
        self.window = pygame.display.set_mode((1430, 700))
    ...
    def update(self, image):
        ...
        for x in range((int)(self.image_width / detail)):
            for y in range((int)(self.image_height / detail)):
                ...
                pygame.draw.rect(self.new_surface, (0, 0, 0,), (x * detail, y * detail, detail, detail))
                font = pygame.font.Font(None, 20)
                self.new_surface.blit(font.render(char, True, pixel_color), (x * detail, y * detail))
        
        self.window.blit (self.new_surface,(750, 50))
